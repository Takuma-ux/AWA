...
def get_text_with_borders():
    try:
        ...
        docx_file_path = os.path.abspath(os.path.join(script_directory, '..', '..', 'input', '240821_3.docx'))
...
# スクリプトのディレクトリを基準にした相対パスを取得
script_directory = os.path.dirname(os.path.abspath(__file__))
output_file_path = os.path.abspath(os.path.join(script_directory, '..','..', 'output', 'get_border_text_08_3.html'))
