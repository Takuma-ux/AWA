...
def create_html_table(docx_path, output_file_path):
...
output_file_path = os.path.abspath(os.path.join(script_directory, '..','..', 'output', 'get_table_text_07.html'))

create_html_table(input_file_path, output_file_path)